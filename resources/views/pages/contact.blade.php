                        ...
                        <div class="form">
                            ...
                            <div class="contact-form">
                                ...
                                <form action="index.html" autocomplete="off">
                                    ...
                                    <div class="custom-input-custom-container">
                                        <select name="services" class="form-select bg-transparent text-white p-2 ps-4" id="service-select">
                                            ...
                                            <option value="service4" class="bg-black">Website Revamping & Bugs Fixes</option>
                                            <option value="service5" class="bg-black">Single Page Application</option>
                                            <option value="service6" class="bg-black">Web Application Development</option>
                                            <option value="others" class="bg-black">Others</option>
                                        </select>
                                    </div>

                                    <div class="custom-input-custom-container" id="other-service-container" style="display: none;">
                                        <input type="text" name="other-service" class="custom-input" id="other-service-input" />
                                        <label for="other-service-input">Other Service</label>
